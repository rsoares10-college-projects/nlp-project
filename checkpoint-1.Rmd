...
tempData <- mice(train.data,m=12,maxit=50,meth='pmm',seed=42)
...
<p> Agora carregaremos  o dataframe de teste e realizaremos algumas as predições necessárias. </p>

````{r}
test.data <- read.csv('test.csv')

# predictions <- predict(train.data, test.data, type = "class")
```
